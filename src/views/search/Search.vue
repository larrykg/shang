              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont"
                             :class="{'icon-up':isAsc,'icon-todown':isDesc}"></span>
                  </a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格
                    <span v-show="isTwo" class="iconfont" :class="{'icon-up':isAsc,'icon-todown':isDesc}"></span>
                  </a>
                </li>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      attrInfo(params) {
        console.log(params);
        let props = `${params.attr.attrId}:${params.attrInfo}:${params.attr.attrName}`;
