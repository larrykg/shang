          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spu,index) in spuSaleAttrList" :key="spu.id">
                ...
                <dd changepirce="0"
                    :class="{active:value.isChecked==1}" v-for="(value,index) in spu.spuSaleAttrValueList"
                    :key="value.id" @click="changeActive(value,spu.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="cont" @change="changeCont">
                <a href="javascript:" class="plus" @click="cont++">+</a>
